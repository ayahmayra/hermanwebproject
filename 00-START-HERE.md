# 🎯 START HERE - WordPress Docker Project

## Selamat Datang! 👋

Project WordPress production-ready yang dapat dikonfigurasi untuk domain dan IP apapun. Proyek ini siap digunakan untuk deployment pemerintahan atau organisasi.
...
### 1️⃣ **QUICK_START.md** ⚡
**Untuk**: Quick deploy 15-20 menit  
**Isi**: Langkah deployment cepat dengan konfigurasi domain/IP  
**Baca jika**: Anda familiar dengan Docker dan ingin deploy cepat

### 2️⃣ **INSTALLATION_GUIDE.md** 📖
**Untuk**: Panduan instalasi lengkap  
**Isi**: Panduan detail termasuk konfigurasi domain dan IP custom  
**Baca jika**: First time deploy atau butuh panduan detail lengkap
...
## 🎯 NEW: Configurable Installation

**Proyek ini sekarang mendukung konfigurasi domain dan IP yang fleksibel!**

Sebelum instalasi, Anda akan menjalankan script konfigurasi:
...
- **Domain**: misalnya `dpmd.bengkaliskab.go.id`
- **IP Lokal**: misalnya `10.10.10.34`
- **Judul Project**: misalnya "DPMD Kabupaten Bengkalis"
- **Email Admin**: misalnya `admin@dpmd.bengkaliskab.go.id`

Semua konfigurasi akan otomatis disesuaikan dengan input Anda!
...
### Prerequisites
- Server Linux (4GB RAM minimum)
- Docker & Docker Compose installed
- Port 80 available
- Domain dan IP lokal sudah disiapkan
...
# 3. Configure domain and IP (NEW!)
./INSTALL.sh
# Masukkan domain, IP lokal, judul, dan email
...
```bash
# Setelah menjalankan INSTALL.sh
make install
# ✅ Otomatis menjalankan langkah 4-7!
```

## 🎉 After Installation

### Access Points
- **Website**: http://your-configured-domain.com
- **Local**: http://your-configured-ip
- **Admin**: http://your-configured-domain.com/wp-admin/

Sesuai dengan domain dan IP yang Anda konfigurasi saat menjalankan `INSTALL.sh`
