...
# Installation
install: check-env secrets build init-wp
	@echo "✓ Installation complete!"
	@echo "Access your site at: http://$${WORDPRESS_DOMAIN} or http://$${WORDPRESS_LOCAL_IP}"
	@$(MAKE) health

check-env:
	@if [ ! -f .env ]; then \
		echo "❌ .env file not found!"; \
		echo "Please run ./INSTALL.sh first to configure your domain and IP"; \
		exit 1; \
	fi
...
adminer:
	...
	@echo "Access Adminer at: http://$${WORDPRESS_LOCAL_IP}:8080"
	@echo "Server: mariadb"
